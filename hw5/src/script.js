let url =["https://tailwindui.com/img/ecommerce-images/home-page-03-hero-image-tile-01.jpg",
...
document.querySelector('.image1').src=url[0];
document.querySelector('.image2').src=url[1];
document.querySelector('.image3').src=url[2];
document.querySelector('.image4').src=url[3];
document.querySelector('.image5').src=url[4];
document.querySelector('.image6').src=url[5];
document.querySelector('.image7').src=url[6];